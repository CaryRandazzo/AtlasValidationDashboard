...
# 2. Put get the path/to/plots_only_tool.py (in my public area) where it can be accessed by the container (afs only)
...
# From there use path/to/plots_only_tool.py -h for docs on how to use plots_only_tools.py