    ...
    for key in tf.GetListOfKeys():
		...
		# We are greater than 3 directories deep and these directories include the specified folders above, goo deeper
            ...
            try:
                ...
                # assuming the file comes from eos system and is of format like this... it must be handled as 2
                # root://eoshome-s.cern.ch//eos/user/s/sawyer/scratch/data24_13p6...root:/run_472943/...
	    ...
	    # Calculate the chi2 values and store them in chi2_dict
            ...
            try:
                ...
                print(e)            
                errors +=1
                print(f'chi2_th1 error on filepath: {f_path_th1}')
